...
const EventForm = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validate() && !isSubmitting) {
      try {
        ...
        // The parent component will handle success/error feedback
      } catch (error) {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-3xl mx-auto border-8 border-[#94EE8F]">
      ...
      {showParentSelector ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            >
              {isSubmitting ? "Creating..." : t("events.submit")}
            </button>
          </div>
        </form>
      )}
