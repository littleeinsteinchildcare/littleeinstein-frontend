//source: https://www.svgrepo.com/svg/405227/dog
    ...
    >
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          className="front-leg"
          fill="#C1694F"
          d="M10.321 21.935s1.016 2.352.676 8.242c-.061 1.057-.209 2.136-.242 3.022c-1.812 0-1.652 2.064-1.268 2.064h2.902c.683 0 1.893-3.438 2.212-8.209c.319-4.772-4.28-5.119-4.28-5.119z"
        ></path>
        ...
        <path
          className="back-leg"
          fill="#C1694F"
          d="M22.211 21.604s.575 3.528 3.651 6.413c.257 1.163.769 4.232.949 5.195c-1.889 0-1.282 2.047-.731 2.047h2.646c.951 0 1.092-3.442.206-7.694c-.885-4.251-6.721-5.961-6.721-5.961z"
        ></path>
