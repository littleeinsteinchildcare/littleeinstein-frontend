...
//       setAccountDetails(accounts[0] as AccountDetails);

//       // Add this block to update the endpoint with the object ID
//       const objectId = (accounts[0] as AccountDetails)?.idTokenClaims?.sub;
...
//                   accountDetails.idTokenClaims.emails.length > 0
